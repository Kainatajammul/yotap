  ...
  return (
   ...
   <div></div>
    ...
    <div className='lead-info'>
     ...
     <h3 style={{fontSize:'25px',fontWeight: '100'}}>{datasearch.name}</h3>
    <div className='person-info'>
    <div>
     <p style={{marginTop:'10px',color:'grey'}}>{datasearch.company}</p>
     <p></p>
    </div>
    <div>
     <p style={{marginTop:'10px',color:'grey'}}>{datasearch.title}</p>
     <p></p>
     </div>
     ...
     <div className='cell-main'>
      ...
      <div className='cell-number'><p>{datasearch.phone}</p></div>
     </div>
     <div className='email-main'>
     <div className='email-head'><p>Email</p></div>
     <div className='email-para'><p>{datasearch.email}</p></div>
     </div>
